...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        browser.find_element_by_css_selector(".SignFlow-accountInput.Input-wrapper input").send_keys("18092671458")
        browser.find_element_by_css_selector(".SignFlow-passwordInput.Input-wrapper input").send_keys("ty158917")
